...
export const LEARN_CONCEPT_INDEX: Readonly<Record<string, string>> = Object.freeze({
  ...
  icc: 'icc',
  // --- Phase 5c — additional diagnostic / advanced test aliases ---
  'anderson-darling': 'shapiro-wilk',
  'kolmogorov-smirnov': 'shapiro-wilk',
  'dagostino-pearson': 'shapiro-wilk',
  bartlett: 'levenes-test',
  'brown-forsythe': 'levenes-test',
  'mixed-effects': 'mixed-effects-lm',
  'mixed-effects-lm': 'mixed-effects-lm',
  // --- Phase 5c — meta-analysis statistics labels ---
  'i-squared': 'heterogeneity',
  'i2': 'heterogeneity',
  heterogeneity: 'heterogeneity',
  'tau-squared': 'heterogeneity',
  'tau2': 'heterogeneity',
  ...
  // --- Phase 5c — RoB / risk of bias tooling ---
  rob2: 'rob2',
  'rob-2': 'rob2',
  'risk-of-bias-2': 'rob2',
  'robins-i': 'robins-i',
  'amstar-2': 'amstar-2',
  'jbi-tools': 'jbi-tools',
  // --- Phase 5c — GRADE certainty domains ---
  grade: 'grade',
  'risk-of-bias': 'grade-risk-of-bias',
  inconsistency: 'grade-inconsistency',
  indirectness: 'grade-indirectness',
  imprecision: 'grade-imprecision',
  // GRADE certainty levels
  high: 'grade',
  moderate: 'grade',
  low: 'grade',
  'very-low': 'grade',
  // --- Phase 5c — PSM / observational concepts ---
  'propensity-score-matching': 'propensity-score-matching',
  psm: 'propensity-score-matching',
  'e-value': 'e-value',
  evalue: 'e-value',
  // --- Phase 5c — RCT / write-up specifics ---
  'itt-analysis': 'itt-analysis',
  itt: 'itt-analysis',
  'multiple-imputation': 'multiple-imputation',
  // --- Phase 5c — Submission / journal selection ---
  'journal-selection': 'picking-a-journal',
